// Write a Cpp program to return the largest span found in the leftmost and rightmost appearances of same value (values are inclusive ) in a given array...
...
int main()
{
  ...
  cout << "\nThe span between the same values in the array is: " << largespan << endl;
  return 0;
}
