...
Enter the size of the 1 array: 3
Enter the 3 elements for 1 array: 3 1 2

The Given 1 array is: 3 1 2
The appearence of elements in the 1 array are consecutive.

Enter the size of the 2 array: 5
Enter the 5 elements for 2 array: 5 1 3 6 2

The Given 2 array is: 5 1 3 6 2
The appearence of elements in the 2 array are not consecutive.

Enter the size of the 3 array: 6
Enter the 6 elements for 3 array: 6 1 5 2 3 4

The Given 3 array is: 6 1 5 2 3 4
The appearence of elements in the 3 array are consecutive.
